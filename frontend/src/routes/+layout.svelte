<script>
	...
	// Navigation items for the sidebar
		...
		{ name: 'Visibility Prediction', path: '/vis-pred', icon: 'vispred', description: 'ML-based visibility forecasting' },
		{ name: 'Anomaly Detection', path: '/anamoly', icon: 'anomaly', description: 'Detect weather anomalies' },
	...
	const icons = {
		...
		vispred: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />`,
		anomaly: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />`
	};
</script>
